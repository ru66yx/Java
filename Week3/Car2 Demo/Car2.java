...
public class Car2
{
    ...
    { 
        ...
        // ----------------------------------------------------
        // Please write your code after this line
        double distX = dist * Math.cos(rotationInRadians); //Distance to Move in x Direction = Distance to Move * cos(Angle of Rotation)
        double distY = dist * Math.sin(rotationInRadians); //Distance to Move in y Direction = Distance to Move * sin(Angle of Rotation)
